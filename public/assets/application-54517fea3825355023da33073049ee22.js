...
(function() { this.JST || (this.JST = {}); this.JST["posts/editPost"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form>\n  <input type="text" class="edit_title text" value="',(''+ post.title ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'">\n  <textarea type="text" class="edit_message text" placeholder="',(''+ post.message ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'"></textarea>\n  <ul class="buttons">\n      <li>\n        <button name="save">Save</button>\n      </li>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["posts/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3 name="post_title" class="post_title text">',(''+ post.title ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</h3>\n<div class="post_message text">\n  <p>',(''+ post.message ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n</div>\n<p class="post_date text">Posted ',(''+ $.formatDateTime('MM dd, y  g:ii a', new Date(post.updated_at)) ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),' by ',(''+ post.username ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</p>\n\n');  if (window.currentUser) { ; __p.push('\n  ');  if (post.user_id === parseInt(window.currentUser.id)) { ; __p.push('\n    <ul class="buttons">\n      <li>\n        <button name="edit">Edit</button>\n      </li>\n      <li>\n        <button name="delete">X</button>\n      </li>\n    </ul>\n  ');  } ; __p.push('\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
var MessageBoard = MessageBoard || {
  Models: {},
  Collections: {},
